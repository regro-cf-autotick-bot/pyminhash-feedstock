...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyminhash-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15030&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyminhash-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyminhash` can be installed with:

```
conda install pyminhash
```

It is possible to list all of the versions of `pyminhash` available on your platform with:
